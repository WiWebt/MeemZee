...
export default function Navbar() {
  ...
  const isEmailPreferencesPage = pathname === '/emailPreferences';
            ...
            <div className="hidden md:flex md:items-center md:gap-8 md:flex-1 md:justify-end">
              ...
              <div className="flex items-center gap-4 ml-8 pl-8 border-l border-gray-200">
                {isEmailPreferencesPage ? (
                  <Link
                    href="/"
                    className="flex items-center gap-2 rounded-lg bg-primary-500 px-4 py-2 text-white shadow-sm hover:bg-primary-600 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="rounded-lg bg-primary-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 transition-colors whitespace-nowrap"
                  >
                    Join Waitlist
                  </button>
                )}
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                {isEmailPreferencesPage ? (
                  <Link
                    href="/"
                    className="flex items-center justify-center gap-2 w-full rounded-lg bg-primary-500 px-3 py-2 text-white hover:bg-primary-600 transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                  ...
                  <button
                    ...
                    className="block w-full rounded-lg bg-primary-500 px-3 py-2 text-center text-base font-medium text-white hover:bg-primary-600"
                  >
                    Join Waitlist
                  </button>
                )}
